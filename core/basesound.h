...
class BaseSound : public QObject {
    ...
    Q_PROPERTY(int waveType READ waveType
            WRITE setWaveType
...
signals:
    ...
    void waveTypeChanged(int waveType);
...
protected:
    ...
    bool mHasRealUrl;
    int wave_type = 0;
    qreal p_env_attack = 0;
    qreal p_env_sustain = 0.3;
    qreal p_env_punch = 0;
    qreal p_env_decay = 0.4;
    qreal p_base_freq = 0.3;
    qreal p_freq_limit = 0;
    qreal p_freq_ramp = 0;
    qreal p_freq_dramp = 0;
    qreal p_vib_strength = 0;
    qreal p_vib_speed = 0;
    qreal p_arp_mod = 0;
    qreal p_arp_speed = 0;
    qreal p_duty = 0;
    qreal p_duty_ramp = 0;
    qreal p_repeat_speed = 0;
    qreal p_pha_offset = 0;
    qreal p_pha_ramp = 0;
    qreal p_lpf_freq = 1;
    qreal p_lpf_ramp = 0;
    qreal p_lpf_resonance = 0;
    qreal p_hpf_freq = 0;
    qreal p_hpf_ramp = 0;
    qreal sound_vol = 0.5f;
};
